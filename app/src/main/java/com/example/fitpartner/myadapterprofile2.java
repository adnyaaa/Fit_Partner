...
public class myadapterprofile2 extends RecyclerView.Adapter<myadapterprofile2.myviewholder>
{
    ArrayList<model> datalist1;

    public myadapterprofile2(ArrayList<model> datalist) {
    ...
    public void onBindViewHolder(@NonNull final myviewholder holder, final int position) {
        String documentId = datalist1.get(position).getDocumentId();
        holder.title_id.setText(datalist1.get(position).getHarga());
        holder.title_id.setText("Link Grup Kelasmu!");
        ...
        holder.statuspembayaran_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(holder.statuspembayaran_id.getContext(), DetailStatusPembayaran.class);
    ...
    class myviewholder extends RecyclerView.ViewHolder{
        ...
        Button daftar, bayar;
        TextView title_id, jadwal_id,status_id, jam_id, judul_id, harga_id, description_id, rekening_id, dokumenid, statuspembayaran_id;
        ImageView nkh;
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            dokumenid= itemView.findViewById(R.id.daftar);
